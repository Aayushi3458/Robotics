    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto active" href="../teams.php">Team</a></li>
        ...
        <table class="table table-bordered">
          ...
          <tbody>
            ...
            <tr>
              ...
              <tr>
                <td>4</td>
                <td>Bannari Amman Institute of Technology (Team:ASSAULT)</td>
                <td>Tamil Nadu</td>
              </tr>

              <tr>
                <td>5</td>
                <td>Bannari Amman Institute of Technology (Team: NOVA)</td>
                <td>Tamil Nadu</td>
              </tr>

              <tr>
                <td>6</td>
                <td>Bannari Amman Institute of Technology (Team: Innovators)</td>
                <td>Tamil Nadu</td>
              </tr>

              <tr>
                <td>7</td>
                <td>Bannari Amman Institute of Technology (Team: ALPHA)</td>
                <td>Tamil Nadu</td>
              </tr>

              <tr>
                <td>8</td>
                <td>Bannari Amman Institute of Technology (Team: Vitality)</td>
                <td>Tamil Nadu</td>
              </tr>
              <tr>
              ...
              <tr>
                <td>9</td>
                <td>Birla Vishvakarma Mahavidyalaya</td>
                <td>Gujarat</td>
              </tr>

              <tr>
                <td>10</td>
                <td>BRACT's Vishwakarma Institute of Technology</td>
                <td>Pune</td>
              </tr>
              ...
              <tr>
                <td>13</td>
                <td>Fr. Conceicao Rodrigues Institute of Technology</td>
                <td>Vashi</td>
              </tr>
              ...
              <tr>
                <td>19</td>
                <td>JSPM Rajarshi shahu college of engineering</td>
                <td>Tathawade</td>
              </tr>
              ...
              <tr>
                <td>31</td>
                <td>MKSSS's Cummins College Of Engineering For Women</td>
                <td>Pune</td>
              </tr>
              ...
              <tr>
                <td>39</td>
                <td>Sardar Vallabhbhai National Institute of Technology (SVNIT)</td>
                <td>Gujarat</td>
              </tr>
              
              <tr>
              <td>40</td>
                <td>Shri Guru Gobind Singhji Institute and Engineering and Technology</td>
                <td>Maharashtra</td>
              </tr>
              
              <tr>
                <td>41</td>
                <td>SRM Institute of Science and Technology, KTR Campus</td>
                <td>Chennai</td>
              </tr>
              ...
              <tr>
              <td>43</td>
                <td>SVKM's Dwarkadas J Sanghvi College of Engineering</td>
                <td>Mumbai</td>
              </tr>
              
              <tr>
                <td>44</td>
                <td>SVKM's NMIMS Mukesh Patel School of Technology Management and Engineering</td>
                <td>Mumbai</td>
              </tr>
              
              <tr>
                <td>45</td>
                <td>U.V.PATEL College of Engineering,Ganppat University</td>
                <td>Pune</td>
